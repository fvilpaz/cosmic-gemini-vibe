...
export const LEVELS: Level[] = [
  ...
  // ─── INDEX 1 — WORLD 9: The Pursuit ──────────────────────────────────────
  {
    ...
    worldLength: 5200,
    enemySpawns: [
      // WAVE 1 — First contact (delayed start, give player breathing room)
      ...
      // HELICOPTER BOSS 1 — appears after wave 1
      ...
      // HELICOPTER BOSS 2 — second encounter, different rival
      ...
      { x: 5150, type: "mistral",    variant: "normal",     behavior: "sprint", size: 1.4 },
    ],
  ...
  // ─── INDEX 2 — WORLD 8: La Granja Loca / MOO ERROR 404 ───────────────────
  {
    ...
    worldLength: 3200,
    enemySpawns: [
      { x: 600,  type: "gpt", variant: "pig",    behavior: "fall",   size: 1.0 },
      { x: 1050, type: "gpt", variant: "pig",    behavior: "fall",   size: 1.0 },
      { x: 1500, type: "gpt", variant: "pig",    behavior: "fall",   size: 1.0 },
      { x: 1900, type: "gpt", variant: "pig",    behavior: "fall",   size: 1.0 },
      { x: 2300, type: "gpt", variant: "pig",    behavior: "fall",   size: 1.0 },
      { x: 2700, type: "gpt", variant: "farmer", behavior: "walk",   size: 1.2 },
      { x: 3000, type: "gpt", variant: "cow",    behavior: "sprint", size: 0.9 },
    ],
    dollarSpawns: [900, 1800, 2700],
    flyerSpawns: [1400, 2500],
    platforms: [
  ...
  // ─── INDEX 3 — WORLD 7: El Oeste — Ride or Die ───────────────────────────
  {
    ...
    worldLength: 3200,
    enemySpawns: [
      { x: 700,  type: "gpt",        variant: "native_rider", behavior: "sprint", size: 1.1 },
      { x: 1150, type: "claude",     variant: "native",       behavior: "sprint", size: 1.0 },
      { x: 1600, type: "copilot",    variant: "native_rider", behavior: "sprint", size: 1.2 },
      { x: 2050, type: "deepseek",   variant: "native",       behavior: "walk",   size: 1.1 },
      { x: 2500, type: "llama",      variant: "native_rider", behavior: "sprint", size: 1.0 },
      { x: 2900, type: "grok",       variant: "native_rider", behavior: "sprint", size: 1.2 },
    ],
    dollarSpawns: [1000, 2000, 3000],
    flyerSpawns: [1600],
    platforms: [
      { x: 1200, y: 200, width: 300 },
      { x: 2400, y: 150, width: 200 },
    ],
  },
