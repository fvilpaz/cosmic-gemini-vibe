...
export const LEVELS: Level[] = [
  ...
  // ─── INDEX 1 — WORLD 9: La Persecución ───────────────────────────────────
  {
    number: 9,
    planetName: "World 9 — La Persecución",
    ...
    worldLength: 10000,
    enemySpawns: [
      { x: 600, type: "claude", variant: "normal", behavior: "walk", size: 1.3 },
      { x: 1035, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
      { x: 1689, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
      { x: 2197, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
      { x: 2600, type: "copilot", variant: "normal", behavior: "roll" },
      { x: 2655, type: "gpt", variant: "normal", behavior: "bounce", size: 1.2 },
      { x: 3105, type: "gpt", variant: "normal", behavior: "roll", size: 1.6 },
      { x: 3516, type: "gpt", variant: "normal", behavior: "walk", size: 1.3 },
      { x: 3916, type: "claude", variant: "normal", behavior: "walk", size: 1.3 },
      { x: 4477, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
      { x: 5158, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
      { x: 5966, type: "copilot", variant: "normal", behavior: "roll" },
      { x: 6538, type: "gpt", variant: "normal", behavior: "bounce", size: 1.2 },
      { x: 7198, type: "gpt", variant: "normal", behavior: "roll", size: 1.6 },
      { x: 7606, type: "gpt", variant: "normal", behavior: "walk", size: 1.3 },
      { x: 8155, type: "claude", variant: "normal", behavior: "walk", size: 1.3 },
      { x: 8850, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
      { x: 9546, type: "gpt", variant: "normal", behavior: "sprint", size: 1.1 },
    ],
    dollarSpawns: [800, 2400, 3600, 6500, 8000, 9500],
    flyerSpawns: [2800, 6000, 8500],
    platforms: [
      { x: 1200, y: 150, width: 300 },
  ...
  {
    number: 8,
    planetName: "World 8 — La Granja Loca / MOO ERROR 404",
  ...
  {
    number: 6,
    planetName: "World 6 — Nave Alien — Escape Protocol",
    themeColor: "from-zinc-950 via-slate-900 to-black",
  ...
  {
    number: 5,
    planetName: "World 5 — La Galaxia — UFO Invasion",
  ...
  {
    number: 4,
    planetName: "World 4 — Océano Alienígena",
  ...
  {
    number: 3,
    planetName: "World 3 — Jungla Digital — The Green Cascade",
